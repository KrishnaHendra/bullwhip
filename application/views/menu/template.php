...
<html lang="en">
    ...
    <body class="nav-fixed">
        <nav class="topnav navbar navbar-expand shadow navbar-light bg-white" id="sidenavAccordion">
            <a class="navbar-brand" href="index.html">Bullwhip Emma</a>
            ...
            <ul class="navbar-nav align-items-center ml-auto">
                <li class="nav-item dropdown no-caret mr-3 d-none d-md-inline">
                    <a class="nav-link dropdown-toggle" id="navbarDropdownDocs" href="javascript:void(0);" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="d-none d-md-inline font-weight-500 text-capitalize"><?= $this->session->userdata('bagian') ?></div>
                    ...
                    <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                        <h6 class="dropdown-header d-flex align-items-center">
                            ...
                            <div class="dropdown-user-details">
                                <div class="dropdown-user-details-name"><?= $this->session->userdata('nama_pegawai'); ?></div>
                                <div class="dropdown-user-details-email"><?= $this->session->userdata('bagian'); ?></div>
                            </div>
                        </h6>
                ...
                <nav class="sidenav shadow-right sidenav-light">
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <a class="nav-link <?php if($active == 'home') echo 'active'; ?>" href="<?= base_url('index.php/home') ?>">
                                <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                                Home
                            </a>
                            <a class="nav-link <?php if($active == 'bagian') echo 'active'; ?>" href="<?= base_url('index.php/bagian') ?>">
                                <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                                Bagian
                            </a>
                            <a class="nav-link <?php if($active == 'barang') echo 'active'; ?>" href="<?= base_url('index.php/barang') ?>">
                                <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                                Barang
                            </a>
                            <a class="nav-link <?php if($active == 'pegawai') echo 'active'; ?>" href="<?= base_url('index.php/pegawai') ?>">
                                <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                                Pegawai
                            </a>
                    ...
                    <div class="sidenav-footer">
                        <div class="sidenav-footer-content">
                            ...
                            <div class="sidenav-footer-title"><?= $this->session->userdata('nama_pegawai'); ?></div>
                        </div>
                    </div>
                </nav>
            </div>
