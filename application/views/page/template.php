...
<body class="nav-fixed">
            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <a class="nav-link" href="<?= base_url('index.php/bagian') ?>">
                            <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                            Bagian
                        </a>
                        ...
                        <a class="nav-link" href="<?= base_url('index.php/produksi') ?>">
                            <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                            Produksi
                        </a>
    ...
    <?php if ($this->session->flashdata('notif') == 'tambah_sukses') { ?>
        <script>
            Swal.fire(
                'Berhasil',
    ...
    <?php } ?>
    <?php if ($this->session->flashdata('notif') == 'edit_sukses') { ?>
        <script>
            Swal.fire(
                'Berhasil',
    ...
    <?php } ?>
    <?php if ($this->session->flashdata('notif') == 'hapus_sukses') { ?>
        <script>
            Swal.fire(
                'Berhasil',
